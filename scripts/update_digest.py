#!/usr/bin/env python3
"""
Update ServiceNow Jobs Digest for 2026-05-05
- Add new jobs from Hunt UK
- Update index.html with recent jobs
...
# Today's jobs from Hunt UK (freshly scraped)
TODAY_JOBS = [
    {
    ...
    },
    {
        ...
        "url": "https://huntukvisasponsors.com/job/servicenow-senior-developer-11-months-contract-hybrid-at-mygwork-lgbtq2b-business-7ubxo60uzuma",
        "date": "4/22/2026"
    },
    {
...
if __name__ == "__main__":
    ...
    # Step 1: Update all-jobs.html with new jobs
    update_all_jobs_html(TODAY_JOBS)
    
    # Step 2: Update index.html with latest jobs
